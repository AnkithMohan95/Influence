...
install_or_load <- function(mypkg){
...
#Load packages
#install_or_load(ProNet) No longer supported
install_or_load(igraph)
install_or_load(abind)
install_or_load(sna)
install_or_load(ergm.count)
install_or_load(network)
#install_or_load(tcltk) No longer supported
install_or_load(tcltk2)
